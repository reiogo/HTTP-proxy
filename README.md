...
This is a toy proxy that I built from scratch. It is the result of a project from the book CSAPP (https://csapp.cs.cmu.edu/3e/labs.html), which mainly just defines the required scope (you can read the writeup here: https://csapp.cs.cmu.edu/3e/proxylab.pdf). 
